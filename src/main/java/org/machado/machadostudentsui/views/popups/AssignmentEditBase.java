...
public abstract class AssignmentEditBase {
    ...
    protected abstract void processLabels(List<StudentsAssignment> listStudentsAssignment);
    ...
    public void init(
        ...
        processLabels(listStudentsAssignment);
